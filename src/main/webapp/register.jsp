			...
			<div class="col-md-6 offset-md-3">
				<div class="card mt-4">
					<div class="card-header text-center text-white bg-custom">
						...
						%>
						<%
						   String regms=(String)session.getAttribute("failed-msg");
						if(regms!=null)
						{
						%>
						...
						<form action="UserServlet" method="post">
							...
							<div class="form-group">
								<input type="password" class="form-control"
									id="exampleInputPassword1" placeholder="Password" name="upass"  Required="required">
							</div>
...
<p class="text-center text-white">created by Hemant and Manoj</p>
<p  class="text-center text-white">any problem then contact us mydiary@gmail.com</p>
</div>
